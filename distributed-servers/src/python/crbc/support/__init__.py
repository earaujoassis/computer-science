...
class CRBCNameAlreadyInUse(CRBCEstablishment):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCNameAlreadyInUse, self).__init__(complete=complete, header=header, body=body)
...
class CRBCNameRevocation(CRBCEstablishment):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCNameRevocation, self).__init__(complete=complete, header=header, body=body)
    self.set_method(CRBCEstablishment.Reject)
    if name:
      self.set_name(name)
    self.set('Status-code', self.status_code)
...
class CRBCNameAccepted(CRBCEstablishment):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCNameAccepted, self).__init__(complete=complete, header=header, body=body)
...
class CRBCReceived(CRBCCommunication):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCReceived, self).__init__(complete=complete, header=header, body=body)
...
class CRBCWhatThaHeck(CRBCData):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCWhatThaHeck, self).__init__(complete=complete, header=header, body=body)
...
class CRBCTheBadMessage(CRBCData):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCTheBadMessage, self).__init__(complete=complete, header=header, body=body)
    self.set_method(CRBCData.General)
    if name:
      self.set_name(name)
    self.set('Status-code', self.status_code)
...
class CRBCDestinationUnknown(CRBCCommunication):
  ...
  def __init__(self, name='', complete=None, header={}, body=''):
    super(CRBCDestinationUnknown, self).__init__(complete=complete, header=header, body=body)
